...
/**
 * La classe {@code TextFileFilter} rappresenta un filtro che seleziona solo i
 * file di testo a formattazione semplice con estensione .txt.
 */
public class TextFileFilter implements Predicate<Path> {
